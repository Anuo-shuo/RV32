...
set rc [catch {
  ...
  add_files -quiet D:/e203_35T/e203_35T/e203_35T.runs/synth_1/system.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source D:/e203_35T/e203_35T/e203_35T.srcs/utils_1/imports/e203_35T.rtl/bitstream.tcl"
    source D:/e203_35T/e203_35T/e203_35T.srcs/utils_1/imports/e203_35T.rtl/bitstream.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/e203_35T/e203_35T/e203_35T.srcs/utils_1/imports/e203_35T.rtl/bitstream.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force system.mmi }
  write_bitstream -force system.bit -bin_file
