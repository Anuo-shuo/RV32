...
#
# Generated by export_simulation on Tue Apr 05 17:11:18 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_dtcm.sh' script.

./blk_mem_gen_dtcm.sh -reset_run
...
./blk_mem_gen_dtcm.sh -noclean_files

For more information on the script, please type './blk_mem_gen_dtcm.sh -help'.
