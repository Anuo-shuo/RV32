...
#
# Generated by export_simulation on Tue Apr 05 19:01:29 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_itcm.sh' script.

./blk_mem_gen_itcm.sh -reset_run
...
./blk_mem_gen_itcm.sh -noclean_files

For more information on the script, please type './blk_mem_gen_itcm.sh -help'.
